...
class Smallest:
    ...
    def __cmp__(self, other):
        ...
        True
        """
        return 0 if other.__class__ == self.__class__ else -1
...
class Interval:
    ...
    def __init__(self, lower_bound=-Inf, upper_bound=Inf, **kwargs) -> None:
        ...
        lower_closed = not (
                isinstance(lower_bound, Smallest | Largest)) \
                       and kwargs.get("lower_closed", kwargs.get("closed", True))
        upper_closed = not (
                isinstance(upper_bound, Smallest | Largest)) \
    ...
    def __repr__(self) -> str:
        ...
        """
        return "Interval({}, {}, lower_closed={}, upper_closed={})".format(
...
class BaseIntervalSet:
    ...
    def issubset(self, other):
        ...
        True
        """
        operand = other if isinstance(other, BaseIntervalSet) else self.__class__(other)
        return self <= operand
    ...
    def _add(self, obj):
        ...
        r = obj if isinstance(obj, Interval) else Interval.equal_to(obj)
...
class FrozenIntervalSet(BaseIntervalSet):
    ...
    def __repr__(self) -> str:
        ...
        """
        return "FrozenIntervalSet([{}])".format(
            ", ".join(repr(i) for i in self.intervals))
