...
from .evm_instructions import push, swap, address, balance, not_, shl, shr, sar, and_, or_, xor, iszero, eq, sgt, slt, \
    gt, lt, mulmod, addmod, stop, add, mul, sub, div, sdiv, mod, smod, origin, caller, callvalue, blockhash, number, \
    pop, mload, mstore, mstore8, sload, sstore, jump, jumpi, tload, tstore, push0, dup, selfdestruct, invalid, return_, \
    revert
